    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Administrateur'), ('acheteur', 'Acheteur Public'), ('evaluateur', 'Évaluateur'), ('soumissionnaire', 'Soumissionnaire'), ('auditeur', 'Auditeur')], default='soumissionnaire', max_length=30)),
                ('phone', models.CharField(blank=True, max_length=20)),
                ('company_name', models.CharField(blank=True, max_length=255)),
                ('rccm', models.CharField(blank=True, max_length=100, verbose_name='RCCM')),
